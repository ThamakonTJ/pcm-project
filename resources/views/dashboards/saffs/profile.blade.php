        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body box-profile">
              ...
              <p class="text-muted text-center">Warehouse staff</p>
          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="#personal_info" data-toggle="tab">ข้อมูลส่วนตัว</a></li>
            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="active tab-pane" id="personal_info">
                  <form class="form-horizontal" method="POST" action="{{ route('saffUpdateInfo') }}" id="SaffInfoForm">
                    @csrf
                ...
                <div class="tab-pane" id="change_password">
                    <form class="form-horizontal" action="{{ route('saffChangePassword') }}" method="POST" id="changePasswordSaffForm">
                      @csrf
                      <div class="form-group row">
