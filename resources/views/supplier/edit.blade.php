                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="sup_id" value="{{ $supplier->sup_id}}" class="form-control">
                                @error('sup_id')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="product_type" value="{{ $supplier->product_type}}" class="form-control">
                                @error('product_type')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="since"  value="{{ $supplier->since}}" class="form-control">
                                @error('since')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="registered_capital" value="{{ $supplier->registered_capital}}" class="form-control">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_name"  value="{{ $supplier->contact_name}}" class="form-control">
                                @error('contact_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
